export default function App() {
  return (
    <div className="App">
      ...
      <button>Referência da API</button><hr></hr>
      <h2>Crie interfaces de usuário de componentes</h2>
      <p>React permite que você construa interfaces de usuário a partir de pedaços individuais chmados componentes.</p><hr></hr>
      <h2>Escreva componentes com código e marcação</h2>
      <p>Componentes React são funções JavaScript. A sintaxe de marcação é chamada de JSX. É uma extensão da sintaxe JavaScript popularizada pelo React.</p><hr></hr>
